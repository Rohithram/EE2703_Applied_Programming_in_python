...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{}Plotting original function vs expected function for exp(x)}
        ...
        \PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Figure 1 : Plot of \PYZdl{}e\PYZca{}}\PY{l+s+si}{\PYZob{}x\PYZcb{}}\PY{l+s+s2}{\PYZdl{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{}Plotting original function vs expected function for cos(cos((x)))}
        ...
        \PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Figure 2 : Plot of \PYZdl{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{cos(}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{cos(x))\PYZdl{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
        \PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{x}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{}function to create \PYZsq{}A\PYZsq{} matrix for calculating function back from coefficients}
        ...
        \PY{k}{def} \PY{n+nf}{createAmatrix}\PY{p}{(}\PY{n}{nrow}\PY{p}{,}\PY{n}{ncol}\PY{p}{,}\PY{n}{x}\PY{p}{)}\PY{p}{:}
            ...
            \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{n+nb}{int}\PY{p}{(}\PY{p}{(}\PY{n}{ncol}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}\PY{p}{:}
...
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Plotting}
         ...
         \PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Figure 3 : Fourier coefficients of \PYZdl{}e\PYZca{}}\PY{l+s+si}{\PYZob{}x\PYZcb{}}\PY{l+s+s2}{\PYZdl{} (semi\PYZhy{}log)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{fig4} \PY{o}{=} \PY{n}{figure}\PY{p}{(}\PY{p}{)}
         ...
         \PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Figure 4 : Fourier coefficients of \PYZdl{}e\PYZca{}}\PY{l+s+si}{\PYZob{}x\PYZcb{}}\PY{l+s+s2}{\PYZdl{} (Log\PYZhy{}Log)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Magnitude of coeffients}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{fig5} \PY{o}{=} \PY{n}{figure}\PY{p}{(}\PY{p}{)}
         ...
         \PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Figure 5 : Fourier coefficients of \PYZdl{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{cos(}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{cos(x))\PYZdl{} (semi\PYZhy{}log)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Magnitude of coeffients}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{fig6} \PY{o}{=} \PY{n}{figure}\PY{p}{(}\PY{p}{)}
         ...
         \PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Figure 6 : Fourier coefficients of \PYZdl{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{cos(}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{cos(x))\PYZdl{}  (Log\PYZhy{}Log)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Magnitude of coeffients}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{}Function to calculate coefficients using lstsq and by calling }
         ...
         \PY{k}{def} \PY{n+nf}{getCoeffByLeastSq}\PY{p}{(}\PY{n}{f}\PY{p}{,}\PY{n}{low\PYZus{}lim}\PY{p}{,}\PY{n}{upp\PYZus{}lim}\PY{p}{,}\PY{n}{no\PYZus{}points}\PY{p}{)}\PY{p}{:}
             ...
             \PY{c+c1}{\PYZsh{} drop last term to have a proper periodic integral}
             \PY{n}{x1} \PY{o}{=} \PY{n}{x1}\PY{p}{[}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{n}{b} \PY{o}{=} \PY{p}{[}\PY{p}{]}
             \PY{n}{b} \PY{o}{=} \PY{n}{f}\PY{p}{(}\PY{n}{x1}\PY{p}{)}
             \PY{n}{A} \PY{o}{=} \PY{n}{createAmatrix}\PY{p}{(}\PY{n}{no\PYZus{}points}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{51}\PY{p}{,}\PY{n}{x1}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} Calling function and storing them in respective vectors.}
         \PY{n}{coeff\PYZus{}exp} \PY{o}{=} \PY{n}{getCoeffByLeastSq}\PY{p}{(}\PY{n}{fexp}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{pi}\PY{p}{,}\PY{l+m+mi}{401}\PY{p}{)}
         \PY{n}{coeff\PYZus{}coscos} \PY{o}{=} \PY{n}{getCoeffByLeastSq}\PY{p}{(}\PY{n}{fcoscos}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{pi}\PY{p}{,}\PY{l+m+mi}{401}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}24}]:} \PY{n}{dev1}\PY{p}{,}\PY{n}{maxdev1} \PY{o}{=} \PY{n}{compareCoeff}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}
         ...
         \PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Figure 7 : Deviation between Coefficients for \PYZdl{}e\PYZca{}}\PY{l+s+si}{\PYZob{}x\PYZcb{}}\PY{l+s+s2}{\PYZdl{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\end{Verbatim}
      ...
      \begin{Verbatim}[commandchars=\\\{\}]
The largest deviation for exp(x) : 1.33273
...
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} Plotting the deviation vs n }
         ...
         \PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Figure 8 : Deviation between coefficients for \PYZdl{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{cos(}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{cos(x))\PYZdl{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{n}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Magnitude of Deviations}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
