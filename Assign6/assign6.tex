...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} To get the arguments using sys.argv from command line}
        ...
        \PY{k}{else}\PY{p}{:}
            ...
            \PY{n}{u0}\PY{o}{=}\PY{l+m+mi}{7}                    \PY{c+c1}{\PYZsh{} threshold velocity.}
            \PY{n}{p}\PY{o}{=}\PY{l+m+mf}{0.5}                  \PY{c+c1}{\PYZsh{} probability that ionization will occur}
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} For loop to run the simulation nk times}
        \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{nk}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{xx}\PY{p}{,}\PY{n}{u}\PY{p}{,}\PY{n}{dx} \PY{o}{=} \PY{n}{updatePosVel}\PY{p}{(}\PY{n}{xx}\PY{p}{,}\PY{n}{u}\PY{p}{,}\PY{n}{dx}\PY{p}{)}  \PY{c+c1}{\PYZsh{}update position,velocity of electrons which hit}
        \PY{n}{anode}
            ...
            \PY{n}{xx}\PY{p}{[}\PY{n}{kl}\PY{p}{]} \PY{o}{=} \PY{n}{xx}\PY{p}{[}\PY{n}{kl}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{dx}\PY{p}{[}\PY{n}{kl}\PY{p}{]}\PY{o}{*}\PY{n}{random}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{kl}\PY{p}{)}\PY{p}{)}  \PY{c+c1}{\PYZsh{}updating position after collision}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{assign6_files/assign6_15_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{assign6_files/assign6_17_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{assign6_files/assign6_19_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
