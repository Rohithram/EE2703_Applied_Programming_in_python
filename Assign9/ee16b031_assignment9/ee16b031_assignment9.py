...
Xlims = [-15,15]
Ylims = []
plot_FFT(t,Y,w,1e-4,Xlims,r"Figure 3: Incorrect Spectrum of $(1+0.1\cos(t))\cos(10t)$","3")
t,Y,w = findFFT(-4*pi,4*pi,512,f,2)
Xlims = [-15,15]
Ylims = []
plot_FFT(t,Y,w,1e-4,Xlims,r"Figure 4 : Spectrum of $\left(1+0.1\cos\left(t\right)\right)\cos\left(10t\right)$","4")
...
for i in range(1,10):
    ...
    t,Y,w = findFFT(-window_size/2,window_size/2,sampling_rate,f,6,norm_factor)
...
Xlims = [-10,10]
plot_FFT(t,Y,w,1e-2,Xlims,r"Figure 8: Spectrum of $e^{-\frac{t^{2}}{ 2}}$","8")
