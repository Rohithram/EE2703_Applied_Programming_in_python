...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k+kn}{import} \PY{n+nn}{writefile\PYZus{}run} \PY{k}{as} \PY{n+nn}{writefile\PYZus{}run}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{writefile\PYZus{}run} ee16b031\PYZus{}assignment9.py
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{writefile\PYZus{}run} ee16b031\PYZus{}assignment9.py \PYZhy{}a
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{writefile\PYZus{}run} ee16b031\PYZus{}assignment9.py \PYZhy{}a
         
         t,Y,w = findFFT(0,2*pi,128,f,2)
         Xlims = [\PYZhy{}15,15]
         Ylims = [\PYZhy{}pi,pi]
         plot\PYZus{}FFT(t,Y,w,1e\PYZhy{}4,Xlims,
                  r\PYZdq{}Figure 3: Incorrect Spectrum of \PYZdl{}(1+0.1\PYZbs{}cos(t))\PYZbs{}cos(10t)\PYZdl{}\PYZdq{},\PYZdq{}3\PYZdq{}
                  ,Ylims)
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{writefile\PYZus{}run} ee16b031\PYZus{}assignment9.py \PYZhy{}a
         
         t,Y,w = findFFT(\PYZhy{}4*pi,4*pi,512,f,2)
         Xlims = [\PYZhy{}15,15]
         Ylims = [\PYZhy{}pi,pi]
         plot\PYZus{}FFT(t,Y,w,1e\PYZhy{}4,Xlims,
         r\PYZdq{}Figure 4 : Spectrum of \PYZdl{}\PYZbs{}left(1+0.1\PYZbs{}cos\PYZbs{}left(t\PYZbs{}right)\PYZbs{}right)\PYZbs{}cos\PYZbs{}left(10t\PYZbs{}right)\PYZdl{}\PYZdq{},
         \PYZdq{}4\PYZdq{},Ylims)
\end{Verbatim}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{writefile\PYZus{}run} ee16b031\PYZus{}assignment9.py \PYZhy{}a
         
         t,Y,w = findFFT(\PYZhy{}4*pi,4*pi,512,f,3)
         Xlims = [\PYZhy{}15,15]
         Ylims = [\PYZhy{}2*pi,2*pi]
         plot\PYZus{}FFT(t,Y,w,1e\PYZhy{}4,Xlims,r\PYZdq{}Figure 5: Spectrum of \PYZdl{}\PYZbs{}sin \PYZca{}\PYZob{}3\PYZcb{}(t)\PYZdl{}\PYZdq{},\PYZdq{}5\PYZdq{},Ylims)
\end{Verbatim}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{writefile\PYZus{}run} ee16b031\PYZus{}assignment9.py \PYZhy{}a
         
         
         t,Y,w = findFFT(\PYZhy{}4*pi,4*pi,512,f,4)
         Xlims = [\PYZhy{}15,15]
         Ylims = [\PYZhy{}pi,pi]
         plot\PYZus{}FFT(t,Y,w,1e\PYZhy{}4,Xlims,r\PYZdq{}Figure 6: Spectrum of \PYZdl{}\PYZbs{}cos\PYZca{}\PYZob{}3\PYZcb{}(t)\PYZdl{}\PYZdq{},\PYZdq{}6\PYZdq{},Ylims)
\end{Verbatim}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{o}{\PYZpc{}\PYZpc{}}\PY{k}{writefile\PYZus{}run} ee16b031\PYZus{}assignment9.py \PYZhy{}a
         ...
         for i in range(1,10):
             ...
             t,Y,w = findFFT(\PYZhy{}window\PYZus{}size/2,window\PYZus{}size/2,
                             sampling\PYZus{}rate,f,6,norm\PYZus{}factor)
